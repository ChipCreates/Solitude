  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Card Content */}
          <div style={{ position: 'absolute', width: '100%', height: '100%', padding: compact ? '4px' : '8px' }}>
            {compact ? (
              <div style={{ fontWeight: 'bold', fontSize: '14px', color: suitColor, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div>{rankStr}</div>
                <div>{suitStr}</div>
              </div>
            ) : (
